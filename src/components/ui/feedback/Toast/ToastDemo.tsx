...
function ToastButtons() {
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <button
        type="button"
        className="inline-flex items-center justify-center gap-2 rounded-md bg-green-800 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-900"
        onClick={() =>
          toast({
            variant: 'success',
            title: 'Success!',
      ...
      <button
        type="button"
        className="inline-flex items-center justify-center gap-2 rounded-md bg-amber-600 px-4 py-2 text-sm font-medium text-[var(--gray-950)] transition-colors hover:bg-amber-700"
        onClick={() =>
          toast({
            variant: 'warning',
            title: 'Warning',
